...
#check if current directory has a compile_commands.json file.
#If not then set compilation_database_folder to false, else set it to current directory
if(p.isfile('compile_commands.json')):
